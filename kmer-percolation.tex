...
rate. For example, \textasciitilde4.78 bits per k-mer are needed for a false
positive rate of 10\% while \textasciitilde6.22 bits per k-mer are need for a false
positive rate of
