...
sequence. Because the k-mer space is extremely large for large k, a
relatively high false positive rate ($\sim$ 15\%) is still unlikely to
...
with no overlap is $k$ in length {\bf I DON'T BELIEVE YOU}.  Thus, the larger scale graph structure is retained until $p=0.183$, as suggested by the cluster size analysis and percolation results.
% @CTB I DON'T BELIEVE YOU :)
...
number of 17-mers with more than 2 neighbors is proportionally higher
...
% @CTB PROPORTIONALLY? I THINK NOT.
