...
% TODO:
%   tables, figures => separate file?
%   author attributions
%   move acks
%   reference tables!!

\documentclass[12pt]{pnastwo}
...
We did not use Velvet for the partitioning analysis because Velvet has
a stochastic component during error correction that results in
dissimilar assemblies when read order is changed, and hence the
assemblies cannot be easily compared.
...
\begin{figure}
\includegraphics[width=2.5in]{figures/f3b001}
\includegraphics[width=2.5in]{figures/f3b005}\\
\includegraphics[width=2.5in]{figures/f3b010}
\includegraphics[width=2.5in]{figures/f3b015}
...
\hline
1 \% & 2.0gb (16.5x) & 106,025 & 344,426 \cr
5 \% & 1.55gb (21.3x) & 217,435 & 344,426 \cr
10 \% & 1.43gb (23.1x) & 1,048,205 & 344,428 \cr
15 \% & 2.2gb (15x) & 3,495,559 & 344,784 \cr
\hline
\end{tabular*}
