...
positive rates while $f_p \le 0.15$ (Figure \ref{fig:partfp}).
...
theoretical memory usage (Figure @@) and actual memory usage compared
...
partition, which here is very small (345,000 reads; Table
\ref{table:parts}) due to the high diversity of soil and the
...
microbes; scaling de novo assembly is a critical part of this
...
variation \cite{zerbinothesis,zhang2003dna,price2005novo,iqbalcortex}.
...
efficiently store graphs in memory may also result in additional uses
