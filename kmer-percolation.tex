...
graph.  In particular, the memory requirements for downstream assembly
...
in false positive rate; this suggests that our theoretical and
simulated results for cluster size and diameter apply to this data set
as well.
